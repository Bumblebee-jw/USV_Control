...
def countChecksum(cmd): #use latitude and longitude as input
    checksum = 0
    for i in cmd:
        checksum += int(i,16)
    #print hex(checksum)
...
def main():
    ...
    firstHalfCmd = header + [hex(points)] +['0x77','0x62', '0x6f', '0x4f', '0x7d', '0xd', '0xb0', '0x36', '0x40', '0xb8', '0x94', '0xf3', '0xc5', '0x5e', '0x8c', '0x5c', '0x40','0x77', '0x47', '0x9', '0xe7', '0x40', '0xfc', '0xaf', '0x36', '0x40','0xa7', '0x3b', '0x4f', '0x3c', '0x67', '0x8c', '0x5c', '0x40']#+infoTuple[0]
    #print firstHalfCmd
